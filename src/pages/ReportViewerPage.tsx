...
const ReportViewerPage: React.FC<ReportViewerPageProps> = ({ data, token }) => {
  ...
  // Safe Purpose & Employment Parsing
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {hasDocuments ? (
                <>
                  <div className="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-white/50 mt-1">in {data?.origin_country || 'Origin Country'}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <p className="text-[9px] font-bold uppercase text-white/40 tracking-widest mb-1">Sector Demand in {data?.destination_country || 'Destination'}</p>
                  ...
                  {ca.income_transfer_narrative && (
                    <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                      <p className="text-[10px] font-black uppercase text-white/40 tracking-widest mb-2">What This Means for You as a Lender</p>
                ...
                <div className="flex items-start gap-3 bg-amber-500/10 rounded-xl p-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/50 mt-1">Income figures below are self-declared by the applicant and have not been verified against documents.</p>
                  </div>
                </div>
              )}
            </Section>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    note: usableDocs.some((d: any) => d.account_holder_name_match === 'Match') ? 'Name matches document(s)' : usableDocs.length > 0 ? 'Partial or no match' : 'No documents to check',
                  },
                  {
                  ...
                  <div key={label} className="flex items-start gap-2.5">
                    {ok ? <CheckCircle size={14} className="text-emerald-500 shrink-0 mt-0.5" /> : <AlertCircle size={14} className="text-amber-400 shrink-0 mt-0.5" />}
                    <div>
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-[10px] text-slate-400 mt-4 leading-relaxed">This report reflects the applicant's financial standing at the time of generation.</p>
            </div>
              ...
              <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 h-2 bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className={`h-full rounded-full ${ca.currency_risk < 30 ? 'bg-emerald-500' : ca.currency_risk < 60 ? 'bg-amber-500' : 'bg-red-500'}`}
                ...
                <p className="text-[10px] text-slate-400 mt-3 leading-relaxed">
                  {ca.currency_risk < 30 ? 'Low currency volatility.' : ca.currency_risk < 60 ? 'Moderate volatility.' : 'High volatility.'}
                </p>
              </div>
            )}
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5">
              ...
              <p className="text-[10px] text-slate-500 leading-relaxed">This report was generated by Persona.Credit, an AI-powered cross-border financial verification service...</p>
              <a href="https://persona.credit" className="text-[10px] font-bold text-blue-500 mt-3 block hover:underline" target="_blank" rel="noopener noreferrer">persona.credit</a>
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="max-w-4xl mx-auto px-6 py-16 text-center border-t border-slate-100 mt-16">
        <p className="text-[10px] font-bold text-slate-300 uppercase tracking-[0.4em]">&copy; {new Date().getFullYear()} Persona.Credit &bull; Cross-Border Financial Verification</p>
        <p className="text-[9px] text-slate-300 mt-2">Report ID: {token ? token.slice(0, 20).toUpperCase() : '—'} &bull; Confidential</p>
      </footer>
    </div>
  );
};
